...
type SearchSettingsDialogProps = {
  open: boolean;
  onOpenChange: (open: boolean) => void;
};

export const SearchSettingsDialog = ({ open, onOpenChange }: SearchSettingsDialogProps) => {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="w-full sm:max-w-4xl overflow-y-auto">
        <SheetHeader>
          <SheetTitle>Innstillinger for søk</SheetTitle>
        </SheetHeader>
